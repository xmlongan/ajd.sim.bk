...
Stochastic Volatility (SV) model and its Affine Jump Diffusion (AJD) 
extensions using the method in Broadie and Kaya (2006), hence the 
name `ajd.sim.bk`. The extended models include
